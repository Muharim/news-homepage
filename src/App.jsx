  ...
  return (
    <div className="pt-[28px] px-[16px] pb-[64px] font-Inter">
      <div className="flex justify-between">
        ...
        <button onClick={toggleCanvas} className="h-fit w-fit relative top-[6px]"><svg width="40" height="17" xmlns="http://www.w3.org/2000/svg"><g fill="#00001A" fillRule="evenodd"><path d="M0 0h40v3H0zM0 7h40v3H0zM0 14h40v3H0z"/><path d="M0 0h40v3H0z"/></g></svg></button>
        {
      ...
      <div className="pt-[60px] pb-6 flex flex-col gap-[34px]">
        <PopularPost 
