  ...
  return (
    <div className=' fixed flex justify-end z-10 w-full left-0 top-0 bg-black/50'>
      <div className='top-0 right-0 w-[68%] h-[100vh] px-[24px] bg-white'>  
        ...
        <ul className='hover:text-softRed pt-[22vh]'>
            <li className='py-[12px] text-[18px]'><a href="#">Home</a></li> 
            <li className='py-[12px] text-[18px]'><a href="#">New</a></li> 
            <li className='py-[12px] text-[18px]'><a href="#">Popular</a></li>
            <li className='py-[12px] text-[18px]'><a href="#">Trending</a></li>
            <li className='py-[12px] text-[18px]'><a href="#">Categories</a></li> 
        </ul> 
      </div>
    </div>
  )
